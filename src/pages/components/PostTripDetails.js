...
import { faExternalLinkAlt, faDownload, faCheckCircle, faRocket, faTimesCircle, faClock, faTag, faArrowLeft, faLocationArrow, faMapPin, faMapMarker, faMapMarkedAlt, faMapMarkerAlt, faCalendar, faMapMarked, faCalendarAlt } from '@fortawesome/free-solid-svg-icons';
...
export default () => {
    ...
    const fetchUserData = async () => {
        try {
          const response = await axios.get(`http://ec2-54-208-162-205.compute-1.amazonaws.com:8082/tripEndDetails?tourId=${id}&bookingId=${bookingId}`);
